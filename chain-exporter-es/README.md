...
2. 프로젝트 빌드를 위해서는 config.yaml 파일이 필요. <br/>
   ...
   ```
   curl https://gist.githubusercontent.com/wannabit-mina/761efa3482cb820ca9bfcb001bd480bb/raw/4af8af8c0dbdaa941cb7aabc08405c5aaf79c588/config.yaml > config.yaml
   ```
