...
2. 프로젝트 빌드를 위해서는 config.yaml 파일이 필요. <br/>
   ...
   ```
   curl https://gist.githubusercontent.com/wannabit-mina/761efa3482cb820ca9bfcb001bd480bb/raw/2554368acfc602106899901f7c2e4a86a05934ae/config.yaml > config.yaml
   ```
