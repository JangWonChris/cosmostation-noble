...
// 	resp, err := c.GetCoingeckoClient().R().Get(queryStr)
// 	if err != nil {
...
// // GetCoinGeckoSimpleCoinPrice returns simple coin price
// func (c *Client) GetCoinGeckoSimpleCoinPrice(id string) (json.RawMessage, error) {
...
// 	resp, err := c.GetCoingeckoClient().R().Get("/coins/" + id + "/market_chart/range?id=" + id + "&vs_currency=usd&from=" + from + "&to=" + to)
// 	if err != nil {
