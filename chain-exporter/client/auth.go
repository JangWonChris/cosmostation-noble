...
// // 	return authtypes.NewQueryClient(c.GRPC)
// }
...
// 	acc, _, err := ar.GetAccountWithHeight(c.GetCLIContext(), accAddr)
// 	if err != nil {
// 		return nil, err
// 	}
...
// 	txResponse, err := authclient.QueryTx(c.GetCLIContext(), hash) // use RPC under the hood
// 	if err != nil {
