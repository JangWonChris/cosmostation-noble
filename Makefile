...
build_exporter: go.sum
	...
	@go build -mod=readonly $(BUILD_FLAGS) -o . ./app/chain-exporter

build_mintscan: go.sum
	@echo "-> Building mintscan"
	@go build -mod=readonly $(BUILD_FLAGS) -o . ./app/mintscan
...
install_exporter: go.sum
	...
	@go install -mode=readonly ${BUILD_FLAG} ./app/chain-exporter

install_mintscan: go.sum
	@echo "-> Installing mintscan"
	@go install -mode=readonly ${BUILD_FLAG} ./app/mintscan
